...
module.exports = function (oService, oCharacteristic, oCommunicationError) {
  ...
  return VeraOccupationSensor;
};
module.exports.VeraSensor = VeraOccupationSensor;

function VeraOccupationSensor(log, data, client, type) {
  // device info
...
VeraOccupationSensor.prototype = {
  ...
  getServices: function() {
    ...
    switch (this.domain) {
      case "Motion":
        ...
        var sensorService = new Service.OccupancySensor();
        break;
      case "Temperature":
    ...
    informationService
      ...
      function handleRequest(request, response){
          ...
          sensorService.getCharacteristic(Characteristic.OccupancyDetected).getValue();
      }
