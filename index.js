...
var VeraSensor;
var VeraSecurity;
var VeraVirtualGateRemote;
//TODO: Add vera scene, rooms and detected alarm here
...
module.exports = function(homebridge){
  ...
  VeraOccupationSensor = require('./accessories/occupationsensor')(Service, Characteristic, communicationError);
  VeraSecurity = require('./accessories/security')(Service, Characteristic, communicationError);
  VeraVirtualGateRemote = require('./accessories/virtualgateremote')(Service, Characteristic, communicationError);

  homebridge.registerPlatform("homebridge-bvera", "bVera", bVera, false);
}

function bVera(log, config, api) {
  ...
  queryDevice: function(device_id, command, callback){
    ...
    switch (command){
      ...
      case 'batterylow':
        ...
        break;
      case 'securitystate':
        url = "http://"+this.host +":3480/data_request?id=variableget&DeviceNum="+device_id+"&serviceId=urn:upnp-bhomesa-co-za:serviceId:bAlarm1&Variable=Status";
        break;
      case 'gatetoggle':
        url = "http://" + this.host + ":3480/data_request?id=variableget&DeviceNum=" + device_id + "&serviceId=urn:upnp-bhomesa-co-za:serviceId:bHomeGate1&Variable=Status";
      break;
  ...
  setDevice: function(device_id, command, value, callback){
    ...
    switch (command){
      ...
      case 'brightness':
         ...
         break;
      case 'securityset':
         url = "http://" + this.host + ":3480/data_request?id=lu_action&output_format=xml&DeviceNum=" + device_id + "&serviceId=urn:upnp-bhomesa-co-za:serviceId:bAlarm1&action=" + value;
         console.log(url);
      break;
      case 'gatetoggle':
        url = "http://"+ this.host + ":3480/data_request?id=lu_action&output_format=xml&DeviceNum=" + device_id + "&serviceId=urn:upnp-bhomesa-co-za:serviceId:bHomeGate1&action=Toggle";
      break;
      ...
      if (error) {
        ...
        body.devices.forEach(function(device) {
          for (var i = 0; i < exludelist.length; i++){
            ...
            else if (device.id == "66"){
              that.log("MANUAL SETTING")
              device.category = 3;
            }
          }//for
          ...
          switch (device.category)
          {
              ...
              case 3:
                ...
                case 4:
                  ...
                  accessory = new VeraOccupationSensor(that.log, device, that, "Motion")
                  ...
                  break;
                case 7:
                 that.log("Found virtual gate remote: " + device.name);
                 accessory = new VeraVirtualGateRemote(that.log, device, that)
                 break;
                case 16:
                ...
                case 22:
                    ...
                    break;
                default:
                  that.log("Device category not recognised... Skipping " + device.name + " " + device.id);
              }//switch
